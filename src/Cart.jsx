        ...
        cartData.length === 0 ?
          ...
          <div className='ecart'>
            <div className='row mt-5'>
              <h1 className='eh1 text-center text-light'>Cart is empty</h1>
            </div>
          </div>
                ...
                {cartData.map((data, index) => (
                  ...
                  <tr key={index}>
                    ...
                    <td className='p-5'>
                      ...
                      <button
                        className='btn btn-danger btn-sm text-light m-3'
                        onClick={() => quanChange(data, -1)}
                      >
                        -
                      </button>
                    ...
                    <td>
                      <button className='btn btn-danger m-5'>View</button>
                    </td>
